...
<html>
<head>
    <title>Welcome to zooplustest</title>
    <link rel="stylesheet" href="<c:url value="/static/zooplustest-webapp.css"/>" type="text/css"
          media="screen, projection"/>
</head>
<div class="container">
    <img src="<c:url value="${logoUrl}" />" alt="Hybris platform logo"/>

    <h2>Welcome to "zooplustest" extension</h2>
    ...
    <div>
        ...
        <ul>
            <li><b>resources/zooplustest-items.xml</b> - here you can model your items</li>
            <li><b>resources/zooplustest-spring.xml</b> - here you can define your services</li>
            <li><b>web/webroot/WEB-INF/config/zooplustest-spring-mvc-config.xml</b> - here is a Spring MVC related
                configuration
            </li>
            <li><b>web/webroot/WEB-INF/config/zooplustest-web-app-config.xml</b> - here you can define web related services,
                facades etc.
            </li>
            <li><b>web/webroot/WEB-INF/config/zooplustest-spring-security-config.xml</b> - here you can configure your Spring Security settings</li>
