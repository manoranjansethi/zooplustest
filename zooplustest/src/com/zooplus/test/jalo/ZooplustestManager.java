...
/**
 * This is the extension manager of the Zooplustest extension.
 */
public class ZooplustestManager extends GeneratedZooplustestManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(ZooplustestManager.class);
	 ...
	 */
	public static ZooplustestManager getInstance()
	{
		return (ZooplustestManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(ZooplustestConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ZooplustestManager() // NOPMD 
	{
		LOG.debug("constructor of ZooplustestManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of ZooplustestManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of ZooplustestManager called, current tenant: {}", getTenant().getTenantID());
	}
