...
public class DefaultZooplustestService implements ZooplustestService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultZooplustestService.class);
	...
	{
		return DefaultZooplustestService.class.getResourceAsStream("/zooplustest/sap-hybris-platform.png");
	}
